...
mines_quarters = mines_quarters[mines_quarters$missing == 0, ] # 12340 observations dropped
...
mines_quarters = mines_quarters[mines_quarters$missing == 0, ] # 563 observations dropped
